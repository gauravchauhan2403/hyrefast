...
const CaseStudies = () => {
  return (
    <div className='bg-[#441949] flex flex-col items-start mx-[1rem] md:mx-[2rem] my-[2rem] rounded-3xl min-h-screen'>
      ...
      <div className=' md:flex items-start justify-between md:mt-[1rem] md:mb-[3rem]'>
        <div className='m-[2rem] md:ml-[6rem] bg-[#6C3B60] p-2 md:p-6 rounded-3xl card flex items-start justify-between'>
          <div>
            <div className='bg-[#33383F] p-2 md:p-3 rounded-full'><img src={Rocket} alt='rocket' /></div>
          </div>
          <div className='text-[#fff] ml-3 md:ml-6'>
            <h2 className='text-xl md:text-2xl font-semibold mb-2'>Use Fin-Tech, E-commerce</h2>
            ...
            <h5 className='text-base mb-2'>Ecommerce, Health &  Wellness, Sales & Marketing</h5>
            <h5 className='text-base ml-1 mb-2'>Developer Engaged - 500 -1,000</h5>
            <button className='p-1 md:p-2 bg-[#441949] rounded-lg font-bold'>Hire in 3 days</button>
          </div>
        </div> {/* end of card */}
        <div className='m-[2rem] md:ml-[6rem] bg-[#6C3B60] p-2 md:p-6 rounded-3xl card flex items-start justify-between'>
          <div>
